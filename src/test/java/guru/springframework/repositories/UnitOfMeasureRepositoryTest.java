...
public class UnitOfMeasureRepositoryTest {
    ...
    public void findByDescription() throws Exception {
        ...
        assertEquals("Teaspoon", unitOfMeasureRepositoryOptional.get().getDescription());
    }

    @Test
    public void findByDescriptionCup() throws Exception {
        Optional<UnitOfMeasure> unitOfMeasureRepositoryOptional = unitOfMeasureRepository.findByDescription("Cup");
        assertEquals("Cup", unitOfMeasureRepositoryOptional.get().getDescription());
    }
 }